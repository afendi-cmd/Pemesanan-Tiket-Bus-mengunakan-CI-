...
<head>
    ...
    <title>Cetak Data Jenis Bus</title>
    <style>
        /* Reset & Base Styles */
        * {
...
<body onload="window.print()">
    <div class="page-container">
        ...
        <!-- Informasi Tambahan -->
        <div class="info-meta">
            <span><strong>Kategori:</strong> Armada Bus</span>
        ...
        <table>
            ...
            <tbody>
                <?php if(!empty($jenisbus)): ?>
                    <?php $no=1; foreach($jenisbus as $j): ?>
                    <tr>
                        <td style="text-align: center;"><?= $no++ ?></td>
                        <td style="font-weight: 500;"><?= htmlspecialchars($j['nama_jenisbus'] ?? '') ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 500;">Big Bus High Deck</td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">2</td>
                        <td style="font-weight: 500;">Medium Bus</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
