...
<body onload="window.print()">
    <div class="page-container">
        ...
        <!-- Informasi Tambahan -->
        <div class="info-meta">
            <span><strong>Kategori:</strong> Struktur Organisasi</span>
            ...
            <tbody>
                <?php if(!empty($jabatan)): ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 500;"><?= htmlspecialchars($j['namajabatan'] ?? '') ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 500;">Direktur Utama</td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">2</td>
                        <td style="font-weight: 500;">Manajer Sumber Daya Manusia</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
