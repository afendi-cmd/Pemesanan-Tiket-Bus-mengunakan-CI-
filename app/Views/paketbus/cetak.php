...
<head>
    ...
    <title>Cetak Data Paket Bus</title>
    <style>
        /* Reset & Base Styles */
        * {
...
<body onload="window.print()">
    <div class="page-container">
        ...
        <!-- Informasi Tambahan -->
        <div class="info-meta">
            <span><strong>Kategori:</strong> Layanan Paket Wisata</span>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Nama Paket</th>
                    <th style="width: 200px; text-align: right;">Harga</th>
                </tr>
            </thead>
            <tbody>
                <?php if(!empty($paketbus)): ?>
                    <?php $no=1; foreach($paketbus as $p): ?>
                    <tr>
                        <td style="text-align: center;"><?= $no++ ?></td>
                        <td style="font-weight: 500;"><?= htmlspecialchars($p['nama_paket'] ?? '') ?></td>
                        <td style="text-align: right; font-weight: 600;">Rp <?= number_format($p['harga'] ?? 0, 0, ',', '.') ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 500;">Paket City Tour Jakarta (Fullday)</td>
                        <td style="text-align: right; font-weight: 600;">Rp 2.500.000</td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">2</td>
                        <td style="font-weight: 500;">Paket Ziarah Wali Songo (3 Hari)</td>
                        <td style="text-align: right; font-weight: 600;">Rp 12.000.000</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
