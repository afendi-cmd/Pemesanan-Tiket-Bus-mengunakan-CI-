...
<div class="container-lg py-3">
    ...
    <div class="header-laporan">
        ...
        <h3>PER PERIODE</h3>
        <p>Periode: <?= htmlspecialchars($tgl_mulai) ?> s/d <?= htmlspecialchars($tgl_akhir) ?></p>
    </div>

    <!-- Informasi Periode -->
    <div class="info-periode">
        <p><strong>Periode Laporan:</strong> <?= htmlspecialchars($tgl_mulai) ?> hingga <?= htmlspecialchars($tgl_akhir) ?></p>
