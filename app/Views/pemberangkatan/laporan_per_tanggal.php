...
<head>
    <meta charset="utf-8">
    <title>Laporan Pemberangkatan Per Tanggal</title>
...
<div class="container-fluid py-5">
    <div class="card shadow no-print mb-4">
        <div class="card-body">
            <h5><i class="mdi mdi-calendar-today me-2"></i>Filter Laporan Pemberangkatan Per Tanggal</h5>
            <form action="<?= base_url('laporanpemberangkatanperiode/perTanggal') ?>" method="get" class="row g-3">
                <div class="col-md-5">
                    <label>Pilih Tanggal</label>
                    <input type="date" name="tanggal_cari" class="form-control" value="<?= htmlspecialchars($tanggal_cari ?? '') ?>" required>
                </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            <div class="text-center mb-4">
                ...
                <p>Tanggal: <?= date('d/m/Y', strtotime($tanggal_cari)) ?></p>
            </div>
                    ...
                    <?php else: ?>
                        <?php $no = 1; foreach ($pemberangkatan as $p): ?>
                            <tr>
                                ...
                                <td><span class="badge bg-success">Berangkat</span></td>
                            </tr>
                        <?php endforeach; ?>
