...
<body onload="window.print()">
        ...
        <header class="report-header">
            ...
            <div class="logo-container">
                <svg class="company-logo" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Elemen Geometris Abstrak (Simbol Pertumbuhan/Puncak) -->
            ...
            <div class="header-text">
                ...
                <p>Telp: (021) 555-1234 | Email: info@inovasitech.id</p>
            </div>
        </header>

        <!-- Informasi Tambahan -->
        <div class="info-meta">
            <span><strong>Unit Kerja:</strong> Sumber Daya Manusia (HRD)</span>
            ...
            <tbody>
                <?php if(!empty($karyawan)): ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 500;"><?= htmlspecialchars($k['nama_karyawan'] ?? '') ?></td>
                        <td><?= htmlspecialchars($k['alamat'] ?? '') ?></td>
                        <td><?= htmlspecialchars($k['email'] ?? '') ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <!-- Mock data untuk demonstrasi tampilan jika variabel PHP kosong -->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 500;">Siti Aminah</td>
                        <td>Jl. Mawar Putih Blok C, Bandung</td>
    ...
    <div class="no-print" style="position: fixed; bottom: 20px; right: 20px;">
        <button onclick="window.print()" style="padding: 12px 24px; cursor: pointer; background: #1a1a1a; color: #fff; border: none; border-radius: 6px; font-weight: bold; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            Cetak Laporan
        </button>
    </div>
</body>
